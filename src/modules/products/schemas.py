...
class ProductBase(BaseModel):
    ...
    size: Annotated[Enum | None, Field(default=None, examples=["M"])]
...
class ProductRead(BaseModel):
    ...
    size: Annotated[str | None, Field(description="The size of the product if it is a clothes (XS,S,M,XL,2XL")]
...
class ProductUpdate(BaseModel):
    ...
    size: Annotated[Size| None, Field(default=None,)]
